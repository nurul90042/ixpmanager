...
<html lang="en">
  ...
  <head>
    ...
    <title>Super Internet eXchange | SIX</title>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-8 col-sm-8 col-7">
          <ul class="info">
            <li><a href="mailto:hello@superxchange.net"><i class="fa fa-envelope"></i>hello@superxchange.net</a></li>
            <li><a href="#"><i class="fa fa-phone"></i>021 4000995 ext.3</a></li>
          </ul>
        </div>
...
>>>>>>> ba38516d43dac3df347fb77bbecea35d49c73627
            </ul>        
