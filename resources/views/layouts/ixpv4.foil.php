...
<html class="h-100" lang="en">
    <head>
        ...
        <link rel="shortcut icon" type="image/ico" href="<?= file_exists( base_path( 'public/images/six/xxArtboard 1 copy 15@3x.png' ) ) ? asset( "xxArtboard 1 copy 15@3x" ) : asset( "xxArtboard 1 copy 15@3x.png" ) ?>" />
